...
export default function HistoryPage() {
  ...
  const fetchHistory = async (p) => {
    ...
    try {
      ...
      const mappedTransactions = (res.data.orders || []).map((o) => ({
        id: o.id,
        type: o.type,
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
        ...
        {loading ? (
          <div className="glass-card" style={{ padding: '48px', textAlign: 'center' }}>
            ...
            <div style={{ color: 'var(--color-text-muted)', fontSize: '14px' }}>Yükleniyor...</div>
          </div>
        ) : (
          <>
            ...
            {totalPages > 1 && (
              <div style={{
                ...
                <button
                  ...
                  style={{ padding: '8px 16px', fontSize: '13px', opacity: page <= 1 ? 0.5 : 1 }}
                >
                  Önceki
                </button>
                <span style={{
                ...
                <button
                  ...
                  className="btn-primary"
                  style={{ padding: '8px 16px', fontSize: '13px', opacity: page >= totalPages ? 0.5 : 1 }}
                >
                  Sonraki
                </button>
              </div>
