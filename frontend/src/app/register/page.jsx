      ...
      <div className="glass-card slide-up" style={{
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '18px' }}>
            ...
            <input type="text" className="input-field" placeholder="Ahmet Yılmaz"
              value={name} onChange={(e) => setName(e.target.value)}
              required minLength={2} id="register-name" />
          </div>
          ...
          <div style={{ marginBottom: '18px' }}>
            ...
            <input type="password" className="input-field" placeholder="En az 6 karakter"
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <input type="password" className="input-field" placeholder="Şifrenizi tekrar giriniz"
              value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}
              required minLength={6} id="register-confirm-password" />
          </div>

          <button type="submit" className="btn-primary" disabled={loading}
            style={{ width: '100%', padding: '14px', fontSize: '16px' }} id="register-submit">
